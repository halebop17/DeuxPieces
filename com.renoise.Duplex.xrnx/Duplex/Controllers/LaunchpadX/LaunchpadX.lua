...
function LaunchpadX:__init(display_name, message_stream, port_in, port_out)
...
function LaunchpadX:release()
  self:send_sysex_message(0x00, 0x20, 0x29, 0x02, 0x0C, 0x0E, 0x00)
...
function LaunchpadX:output_value(pt, xarg, ui_obj)
  -- print(self.port_out)
  if xarg.type == "button" then
    ...
    if xarg.value:sub(1, 3) == "CC#" then
      ...
      self:send_sysex_message(0x00,0x20,0x29, 0x02, 0x0C, 0x03, 0x03,
